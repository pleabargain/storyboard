...
with open(
    "/home/dgd/Desktop/python_storyboard_flashcards/idea_grammar_tracker_tab/common_errors.md"
) as myfile:
...
with open(
    "/home/dgd/Desktop/python_storyboard_flashcards/students/student_names.txt"
) as myfile:
    lines = myfile.readlines()
...
ERROR_LOG_FILENAME = (
    "/home/dgd/Desktop/python_storyboard_flashcards/error_log/error_log.txt"
)
...
def read_list_from_file():
    ...
    open_clean_save(
        "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/nouns.md"
    )
    with open(
        "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/nouns.md"
    ) as myfile:
...
try:
    for root, dirs, files in os.walk(
        "/home/dgd/Desktop/python_storyboard_flashcards/random_images"
    ):
        for name in files:
...
tenses_tab_column_right = sg.Column(
    [  # header
        [
            sg.Multiline(
                "\u0394",
...
negotiation_column_center = sg.Column(
    [
        ...
        [
            sg.Multiline(
                "make suggestions",  # guy face emoji
...
negotiation_column_right = sg.Column(
    [  # header
        [
...
tab_one = sg.Tab(
    ...
    [
        ...
        [
            ...
            sg.Button(
                "edit quantifiers list", tooltip="open editor to edit quantifiers"
            ),
            sg.Button(
                "edit basic question words",
                tooltip="line 883 open local editor to edit basic questions",
            ),
        ],
        [
        ...
        [  # sg.Text(verbs_list,key="verbs_list_box",enable_events=True,size=(15,15)),
            ...
            sg.Listbox(
                subordinating_conjunctions_list,
                key="subordinating_conjunctions_list_box",
                enable_events=True,
                change_submits=True,
                size=(15, 15),
            ),
        ...
        [
            sg.Multiline(
                key="simple_sentence_builder_output",
                size=(70, 10),
                font=("helvetica", 16),
        ...
        [
            sg.Button("reload"),
            sg.Button("randomize", tooltip="click to randomize"),
        ],
        [
            sg.Button(
                "save your created sentence", tooltip="save your work to a text file"
            ),
        ],
    ],
)

storyboard_tenses_tab_two = sg.Tab(
    "storyboard tenses tab",
    [
        # create button
        [
            sg.Button(
            ...
            sg.Combo(
                values=list_of_unwanted_words,
                key="combo_image_filter",
                enable_events=True,
                tooltip="combo_image_filter",
            ),
            sg.Text("filter results: "),
            sg.Text("?", size=(5, 1), key="image_filter_result_number"),
        ...
        [
            tenses_tab_column_left,
            tenses_tab_column_center,
            tenses_tab_column_right,
            bingo_column,
        ],
    ],
)
...
timeline_tab = sg.Tab(
    ...
    [
        ...
        [
            ...
            sg.Button("edit adverbs"),
            sg.Button("place holder"),
        ],
        [
            timeline_column_four,
            timeline_column_one,
            timeline_column_two,
            timeline_column_three,
        ],
    ],
)
####################
...
pros_cons_tab = sg.Tab(
    ...
    [
        ...
        [
            ...
            sg.Button("new topic", tooltip="line 1718"),
            sg.Button("clear fields", tooltip="1720"),
            sg.Button("soft skills list", tooltip="line 1746"),
        ],
        [
            ...
            sg.InputText(key="cons_0", font=("helvetica,14"), size=(30, 1)),
            sg.Slider(
                enable_events=True,
                key="slider_cons_0",
                orientation="horizontal",
        ...
        [
            sg.Text("pros", size=(4, 1)),
            sg.InputText(key="pros_2", font=("helvetica,14"), size=(30, 1)),
            sg.Slider(
                enable_events=True,
                key="slider_pros_2",
                orientation="horizontal",
            ...
            sg.Text("cons", size=(4, 1)),
            sg.InputText(key="cons_2", font=("helvetica,14"), size=(30, 1)),
            sg.Slider(
                enable_events=True,
                key="slider_cons_2",
                orientation="horizontal",
        ...
        [
            sg.Text("pros", size=(4, 1)),
            sg.InputText(key="pros_3", font=("helvetica,14"), size=(30, 1)),
            sg.Slider(
                enable_events=True,
                key="slider_pros_3",
                orientation="horizontal",
            ...
            sg.Text("cons", size=(4, 1)),
            sg.InputText(key="cons_3", font=("helvetica,14"), size=(30, 1)),
            sg.Slider(
                enable_events=True,
                key="slider_cons_3",
                orientation="horizontal",
            ...
            sg.Text(
                "Connecting Words for Illustration",
        ...
        [
            sg.Text("pros", size=(4, 1)),
            sg.InputText(key="pros_4", font=("helvetica,14"), size=(30, 1)),
            sg.Slider(
                enable_events=True,
                key="slider_pros_4",
                orientation="horizontal",
            ...
            sg.Text("cons", size=(4, 1)),
            sg.InputText(key="cons_4", font=("helvetica,14"), size=(30, 1)),
            sg.Slider(
                enable_events=True,
                key="slider_cons_4",
                orientation="horizontal",
        ...
        [
            sg.Text("pros", size=(4, 1)),
            sg.InputText(key="pros_5", font=("helvetica,14"), size=(30, 1)),
            sg.Slider(
                enable_events=True,
                key="slider_pros_5",
                orientation="horizontal",
            ...
            sg.Text("cons", size=(4, 1)),
            sg.InputText(key="cons_5", font=("helvetica,14"), size=(30, 1)),
            sg.Slider(
                enable_events=True,
                key="slider_cons_5",
                orientation="horizontal",
        ...
        [
            sg.Text("pros", size=(4, 1)),
            sg.InputText(key="pros_6", font=("helvetica,14"), size=(30, 1)),
            sg.Slider(
                enable_events=True,
                key="slider_pros_6",
                orientation="horizontal",
            ...
            sg.Text("cons", size=(4, 1)),
            sg.InputText(key="cons_6", font=("helvetica,14"), size=(30, 1)),
            sg.Slider(
                enable_events=True,
                key="slider_cons_6",
                orientation="horizontal",
        ...
        [
            sg.Text("", size=(44, 1)),
            sg.Text("Sum of pros", justification="left", size=(10, 1)),
            sg.Text("?", key="sum_of_pros"),
            sg.Text("", size=(34, 1)),
            sg.Text("Sum of cons", justification="left", size=(10, 1)),
            sg.Text("?", key="sum_of_cons"),
        ],
        ### analysis
        [
            sg.Multiline(
                key="analysis",
                size=(40, 5),
                tooltip="This is a multiline on line 1259 of the code",
                font=("helvetica", 14),
            ),
        ],
        [
            sg.Button(
                ...
                size=(40, 1),
                tooltip="TODO add student name to file save",
            )
        ],
    ],
)
...
for x in range(0, len(top_ten) // 2):
    tracker_layout.append(
        [
            sg.Text(
                top_ten[x], key="label" + str(x), auto_size_text=True, size=(10, 1)
            ),
            sg.InputText(key="input" + str(x), size=(40, 2), tooltip="input" + str(x)),
            sg.Slider(
                enable_events=True,
                key="grammar_slider" + str(x),
                tooltip="grammar_slider" + str(x),
                orientation="horizontal",
                size=(6, 10),
            ),
            sg.Text(
            ...
            sg.InputText(
                key="input" + str(x + 5), size=(40, 2), tooltip="input" + str(x + 5)
            ),
            sg.Slider(
                enable_events=True,
                key="grammar_slider" + str(x + 5),
                tooltip="grammar_slider" + str(x + 5),
                orientation="horizontal",
                size=(6, 10),
            ),
        ],
...
tracker_layout.append(
    [
        sg.Text("performance sum", justification="right", size=(None, None)),
        sg.Input("0", key="performance sum"),
    ],
)
...
tracker_layout.append(
    [
        ...
        sg.Button("save grammar analysis", tooltip="saves JSON"),
    ],
)
tracker_layout.append(
    [
...
worksheet_tab_layout = [
    ...
    [
        sg.Text(
            "selected topics instructions",
            tooltip="line 1575 TODO start pulling from new DB",
        )
    ],
    [
        sg.Multiline(
            default_text="Welcome! You are about to experience\none of the most advanced English classes ever.",
    ...
    [
        sg.Multiline(
            "This will be populated by the db. Here is a a really long prompt to check if the UI can handle it.: ",
    ...
    [
        sg.Text("question #: ", tooltip="q # pulled from db line 1384"),
    ...
    [
        sg.Multiline(
            "This is where the student response goes.",
            # get student input
    ...
    [
        sg.Text("question #: ", tooltip="q # pulled from db line 1687"),
        sg.Text("", key="worksheet_question_number2"),
        # TODO identify radio groupname
        sg.Radio(
            "needs attention",
            "worksheet_RADIO2",
            key="worksheet_needs_attention2",
            default=False,
            size=(None, None),
        ),
    ],
    ...
    # bottom of the tab
    [
        sg.Button("open attention csv", tooltip="line 2009", key="open_attention_csv"),
    ],
]
...
question_tab_layout = [
    ...
    [
        sg.Text("question #: ", tooltip="q # pulled from db line 1699"),
    ...
    # start question area
    [
        sg.Text("Possible Answers: ", font=("helvetica", 18)),
        sg.Input(
            "",
            # get student input
            # this can then be added to the db if time allows
    ...
    [
        ...
        sg.Input(default_text="answer?", key="student_question_choice"),
    ],
...
window = sg.Window(
    "logger version! DATE: "
    + datetime.date.today().strftime("%Y %B %d %A ")
...
while True:
    ...
    if event == "generate_HTML":
        # teacher comment log, date, student name, make pretty HTML output
        # date,student_name.html
       
        filename = "/home/dgd/Desktop/python_storyboard_flashcards/students/" 
        filename += datetime.date.today().strftime("%Y %B %d %A ") 
        filename +=  "_" 
        filename += values["student_name"] 
        filename +=".html"

        with open ("/home/dgd/Desktop/python_storyboard_flashcards/html_templates/base_template.html") as myfile:
            lines = myfile.readlines()
        ...
        for logline in values["vocabulary_log"].splitlines():
            ...
            if logline.startswith("pros and cons: "):
                # render topic without .csv
                topic = logline[15:].replace("|","")
                # get the csv
                CSVPATH = "/home/dgd/Desktop/python_storyboard_flashcards/pros_cons_tab/" + topic.strip() + ".csv"
                lines.append('<td colspan="2">')
                # lines.append("discussing pros and cons "+ topic)
                lines.append("</td></tr>")   
                # DONE open csv file by topic name
                # DONE get last line of CSV
                ...
                #print("-------------")
                #print(row) # this is the last line of the csv, already
                # ----------------- generate pro con table -----------------------
                out = "</table><h3>Discussion of pros and cons of: {}</h3>".format(row["topic"])
            ...
            for colnumber, cell in enumerate(logline.split("|")):
                if colnumber == 0:
                    ...
                    for unwanted in list_of_unwanted_words:
                        if clean_cell.startswith(unwanted):
                            clean_cell=clean_cell.replace(unwanted,"")
                            break
                    #full image path 
                    full_image_name = IMG_PATH+cell.strip()+".png"
                    with open(full_image_name, "rb") as img_file:
                        my_string = base64.b64encode(img_file.read())
                        image_string = my_string.decode("utf-8")
                    # lines.append("<td>{}<br><img src='{}{}.png'></td>".format(clean_cell,IMG_PATH,cell.strip()))
                    lines.append("<td>{}<br> <img src='data:image/png;base64,{}'> </td>".format(clean_cell,image_string))
                elif colnumber==1:
                    if len(cell.strip())>0:
                        challenge_text += "challenge1: "
                    challenge_text += cell + "<br>"
                elif colnumber ==2:
                    if len(cell.strip())>0:
                        challenge_text += "challenge2: "
                    challenge_text += cell 
                    # lines.append("<td>" + challenge_text + "</td>")

                elif colnumber ==3:
                    # lines.append("<td>" + cell + "</td>")
                    if len(cell.strip())>0:
                        challenge_text += "teacher typed: "
                    challenge_text += cell 
                    lines.append("<td>" + challenge_text + "</td>")
    ...
    if event == "TODO_worksheet":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/worksheet_tab/TODO_worksheet_tab.md",
            )
        )
    ...
    if event == "pros_cons_issues":
        read_list_from_file()
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/pros_cons_tab/pros_cons_events.md"
        ) as myfile:
            lines = myfile.readlines()
        selected_topic = random.choice(lines).strip()
    ...
    if event == "linking_words_results":
        read_list_from_file()
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/linking_words_results.md"
        ) as myfile:
            lines = myfile.readlines()
        selected_topic = random.choice(lines).strip()
    ...
    if "connecting_words_concession" in event:
        read_list_from_file()
        open_generic_file(
            "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/connecting_words_concession.md",
            "connecting_words_concession",
        )

    if "connecting_words_summary" in event:
        read_list_from_file()
        open_clean_save(
            "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/connecting_words_summarizing.md"
        )
    ...
    if event == "connecting_words_emphasis":
        read_list_from_file()
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/connecting_words_emphasis.md"
        ) as myfile:
            lines = myfile.readlines()
        selected_topic = random.choice(lines).strip()
    ...
    if event == "connecting_words_illustration":
        read_list_from_file()
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/connecting_words_illustration.md"
        ) as myfile:
            lines = myfile.readlines()
        selected_topic = random.choice(lines).strip()
    ...
    if event == "linking_words_addition":
        read_list_from_file()
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/linking_words_addition.md"
        ) as myfile:
            lines = myfile.readlines()
        selected_topic = random.choice(lines).strip()
    ...
    if event == "linking_words_comparison":
        read_list_from_file()
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/linking_words_comparison.md"
        ) as myfile:
            lines = myfile.readlines()
        selected_topic = random.choice(lines).strip()
    ...
    if event == "linking_words_condition":
        read_list_from_file()
        open_generic_file(
            "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/linking_words_condition.md",
            "linking_words_condition",
        )

    if event == "linking_words_contrast":
        read_list_from_file()
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/linking_words_contrast.md"
        ) as myfile:
            lines = myfile.readlines()
        selected_topic = random.choice(lines).strip()
    ...
    if event == "linking_words_reason":
        read_list_from_file()
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/linking_words_reason.md"
        ) as myfile:
            lines = myfile.readlines()
        selected_topic = random.choice(lines).strip()
    ...
    if event == "soft skills list":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/EnglishHelpsYourCareer/topic_soft_skills.md",
            )
        )
    ...
    if "grammar_slider" in event:
        ...
        window["performance sum"].update(
            values["grammar_slider0"]
    ...
    if event == "date_picker":
        ...
        if student_name == "":
            sg.PopupError(
                "No student json file by that name",
                location=(2000, 100),
            )
            continue
        json_files = glob.glob(
            "/home/dgd/Desktop/python_storyboard_flashcards/students/*.json"
        )
        # print (json_files)
        ...
        window["grammar analysis"].update(
            hold_json[most_recent_date]["grammar analysis"]
        )
        ...
        window["input6"].update(
            hold_json[most_recent_date]["comparatives and superlatives"][0]
        )
        ...
        window["grammar_slider0"].update(
            hold_json[most_recent_date]["passive voice"][1]
        )
        ...
        window["grammar_slider4"].update(
            hold_json[most_recent_date]["connecting words"][1]
        )
        window["grammar_slider5"].update(hold_json[most_recent_date]["prepositions"][1])
        window["grammar_slider6"].update(
            hold_json[most_recent_date]["comparatives and superlatives"][1]
        )
        window["grammar_slider7"].update(
            hold_json[most_recent_date]["phrasal verbs"][1]
        )
        window["grammar_slider8"].update(
            hold_json[most_recent_date]["irregular verbs"][1]
        )
        window["grammar_slider9"].update(
            hold_json[most_recent_date]["pronunciation"][1]
        )
    ...
    if event == "README":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/README.md",
            )
        )
    ...
    if event == "tips":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/tips.md",
            )
        )
    ...
    if event == "load syllabus":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/EnglishHelpsYourCareer/30_week_syllabus.md",
            )
        )
    ...
    if event == "core vocab":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1XfMVJNB4UMy0NU5QteYEUZkmfRUIVNSf19ZuC5A23T8/edit#gid=0",
            new=1,
            autoraise=True,
        )
    ...
    if event == "2 letter words":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/12_mq9Pp5VSyrYeXf1qxsZGXrF22fOI4yQksBoziaT9g/edit?usp=sharing",
            new=0,
            autoraise=True,
        )
    ...
    if event == "3 letter words":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1YZcrl4TU9LKJnaSP-HLUtZkFLuq4cZkU8eCR-X2WwG0/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
        # pass
    ...
    if event == "pron_soft_d":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/pron_ed_soft_d_sound.md",
            )
        ),
    ...
    if event == "pron_ed_id":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/pron_ed_id_sound.md",
            )
        ),
    ...
    if event == "pron_ed_t":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/pron_ed_t.md",
            )
        ),
    ...
    if event == "silent_b":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/silent_b.md",
            )
        ),
    ...
    if event == "pron_k":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/pron_ed_k.md",
            )
        ),
    ...
    if event == "silent_s":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/EnglishHelpsYourCareer/students/English_pronunciation_tips.md",
            )
        ),
    ...
    if event == "M_coordinating":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/coordinating_conjunctions.md",
            )
        ),
    ...
    if event == "M_subordinating":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/subordinating_conjunctions.md",
            )
        ),
    ...
    if event == "rhyme_site":
        os.system(
            "{} {}".format(FIREFOX, "https://www.rhymezone.com/", new=2, autoraise=True)
        )
    ...
    if event == "display_grammar_graph":
        ...
        svg = displacy.render(sentence_nlp, options={"compact": True}, style="dep")
        output_path = Path(
            f"/home/dgd/Desktop/python_storyboard_flashcards/question_tab/{question_number}.{question}.svg"
    ...
    if event == "open_attention_csv":
        os.system(
            "{} {}".format(EXTERNAL_EDITOR, QUESTION_FOLDER + "/needs_attention.csv")
        )
    ...
    if event == "get_next_random_question":
        ...
        try:
            ...
            with open(ERROR_LOG_FILENAME, "a") as myfile:
                myfile.write(
                    f'date: {date_string} | missing instructions: {values["db_category"]}\n'
                )
    ...
    if event == "db_category":
        ...
        window["questions_db_info"].update(
            f"I found questions: {len(lines_of_this_cat)}"
        )
        # randomize order
    ...
    if "slider_grammar" in event:
        sum_of_pros = (
            values["slider_pros_0"]
            + values["slider_pros_1"]
            + values["slider_pros_2"]
            + values["slider_pros_3"]
            + values["slider_pros_4"]
            + values["slider_pros_5"]
            + values["slider_pros_6"]
        )
        sum_of_cons = (
            values["slider_cons_0"]
            + values["slider_cons_1"]
            + values["slider_cons_2"]
            + values["slider_cons_3"]
            + values["slider_cons_4"]
            + values["slider_cons_5"]
            + values["slider_cons_6"]
        )
    ...
    if event == "save grammar analysis":
        ...
        # create JSON file
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/students/"
            + values["student_name"]
            + ".json",
            "a",
        ) as myfile:
    ...
    if event == "save analysis to CSV":
        ...
        if os.path.exists(
            "/home/dgd/Desktop/python_storyboard_flashcards/pros_cons_tab/"
            + csv_file_name
            + ".csv"
        ):
            csv_exists = True
        ...
        sg.PopupOK(
            f"{csv_file_name}.csv' file written to directory\n{os.getcwd()} dir",
            location=(2000, 100),
        )
    ...
    if event in ("irregular verbs",):
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1NM2ZkyO_-DESyWuezXiRqXuKC75qs2Fwxi0mKQbEULY/edit#gid=0",
            new=2,
            autoraise=True,
        )
    ...
    if event in ("phrasal verbs", "phrasal verbs1"):
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1K8RfcM_bAnd9WSRIY-2-roiLcXHU37oKtqrwRVHfDgc/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event == "image_shuffle":
        ...
        if values["combo_image_filter"] == "":
            ...
            image_list = [name for name in original_image_list if wanted in name]
            print(
                "filtered image list: ", values["combo_image_filter"], len(image_list)
            )
            window["image_filter_result_number"].update(len(image_list))
            print(image_list)
            ...
            if len(image_list) < 6:
                for i in range(len(image_list), 6):
                    print(i)
                    image_list.append(
                        "/home/dgd/Desktop/python_storyboard_flashcards/random_images/empty_thumbnail.png"
                    )
    ...
    if "canvas" in event:
        ...
        new = image_list[int(event[6])]
        print(new,type(new))
        # new is too long. only need the stem
        p = Path(new)
        new = p.stem
        text += "\n" + new + " | " + values["bingo_text1"] + " | " + values["bingo_text2"] + " | " + "no comment yet"
    ...
    if event == "edit verbs list":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/verbs.md",
            )
        )
    ...
    if event == "edit adjectives list":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/adjectives.md",
            )
        )
    ...
    if event == "edit quantifiers list":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/word_lists/quantifiers.md",
            )
        )
    ...
    if event == "edit basic question words":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/english_question_words.md",
            )
        )
        webbrowser.open(
            "https://docs.google.com/document/d/1FRGc3k_AkcAbH_w4COKyms9fOjxS7YJfKygv_nin9F4/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event == "reload":
        ...
        window["subordinating_conjunctions_list_box"].update(
            values=subordinating_conjunctions_list
        )

    # button in simple sentence builder
    if event == "randomize":
        window["verbs_list_box"].update(
            set_to_index=random.randint(0, len(verbs_list) - 1)
        )
        window["nouns_list_box"].update(
            set_to_index=random.randint(0, len(nouns_list) - 1)
        )
        window["adjectives_list_box"].update(
            set_to_index=random.randint(0, len(adjectives_list) - 1)
        )
        window["quantifiers_list_box"].update(
            set_to_index=random.randint(0, len(quantifiers_list) - 1)
        )
        window["subordinating_conjunctions_list_box"].update(
            set_to_index=random.randint(0, len(subordinating_conjunctions_list) - 1)
        )
        # (set_to_index=random.randint(0,len(verbs_list)-1))
        # event, values = window.read()
        # print(window["verbs_list_box"].get())
        result = mermaid_template.format(
            window["verbs_list_box"].get()[0],
    ...
    if event == "easy":
        reset_tenses()
        window[random.choice(["past_simple", "past_continuous"])].update(
            background_color="white"
        )
        window[random.choice(["present_simple", "present_continuous"])].update(
            background_color="white"
        )
        window[random.choice(["future_simple", "future_continuous"])].update(
            background_color="white"
        )
    ...
    if event in ("past_simple", "past_simple1"):
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1NkmOcQcNU8Dirk_rM04yEF5CS9yaSnYGip0Tyq0AkIU/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event == "past_continuous":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/14FxeIfy6HA1nFK1HA-t301v-7x2Hf4BoYxnu1hKtm1M/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event == "past_perfect_continuous":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1eQYZQA9qWQLEjEwwgBv6hupkzLELxVWXwZEukJ2He2I/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event == "past_perfect":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1KzJ68cM0VBsthrfsGJRIXCV4MWXcSIcDdDWfH-Gfl3M/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event == "present_simple":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1xv0ZFe6_l66spkXWPyWrzu5k1KPNb3OWKL52Xg71DuE/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event == "present_continuous":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1SKgIK56P0qla0l2KEuii35AjPWrg4YJGYqw2prV7BIw/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event == "present_perfect_continuous":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1mQoBCdNpjYee6lX5sxwz1oS2xpmkVeimY-CVUnRgxoA/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event == "present_perfect":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1vAlXCM5dD8EVvt9W_YYz7ZNN6UZumT0MClnazfF7oGY/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event == "future_simple":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1ipHIxokBppXG_BXsVZ02J-HbXtzA5xLLPSm6prZlZ2Q/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event == "future_continuous":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1ggv9CToDdZBcjTjDF92r5AYOzAzvFhWZSFuraUdT5mE/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event == "future_perfect_continuous":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1ePg18VgsvrrIv1JKcuF6KDTak3jQ46A1ALyv4ElHI5U/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event == "future_perfect":
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1aq_OhW0JRTGNrowS7Q4RCl52cHx7S9Upha7z9VYp-3o/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event in ("comparatives and superlatives", "comparatives and superlatives1"):
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/150r972lV3ogmCmlmpjkHNOoX6tIO26Gd4EYzdfCGUW4/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event in ("idioms", "idioms1"):
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/15u8oWVJNmjvfkOOvF696E1o-Tz6lBZkr7ctJ6CBLYVk/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event in ("prepositional phrases", "prepositional phrases1"):
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1R3rYYL7H7wC86Z8HeNFy_QzCvqXJSv6w8tKb3wsM30E/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event in ("conditionals", "conditionals1"):
        webbrowser.open(
            "https://docs.google.com/spreadsheets/d/1VKcLMETbyEnWpVEeXc5j5NjEa_UF0ydMBInS-ljoWhs/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event in ("modals", "modals1"):
        webbrowser.open(
            "https://docs.google.com/document/d/1KrQamEPrHG4bMQrHc4XJtys-P23iaRC-8iDWXL8sbfY/edit?usp=sharing",
            new=2,
            autoraise=True,
        )
    ...
    if event in ("question modals", "question modals_1"):
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/english_questions_modals_and_auxillaries.md",
            )
        )
    ...
    if event == "edit timeline events":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/timeline_support_tab/timeline_events.md",
            )
        )
    ...
    if event == "edit adverbs":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/timeline_support_tab/grammar_adverbs_of_time.md",
            )
        )
    ...
    if event == "edit prepare_0":
        os.system(
            "{} {}".format(
                EXTERNAL_EDITOR,
                "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/prepare_0.md",
            )
        )
    ...
    if event == "save_negotiation_text_to_md":
        ...
        print(date_part)
        topic = sg.PopupGetText(
            "topic name",
            location=(2000, 100),
        )
        date = sg.PopupGetText(
            "date date",
            location=(2000, 100),
        )
        ...
        print(filename)
        text = NEGOTIATION_TEMPLATE.format(
            values["prepare_0_list_box"],
            values["agenda_01_list_box"],
        )
        # agenda_01_list_box
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/"
            + filename,
            "w",
        ) as myfile:
            myfile.write(text)
    ...
    if event == "agenda1":
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/agenda_01.md"
        ) as myfile:
            lines = myfile.readlines()
    ...
    if event == "proposals2":
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/making_proposals_02.md"
        ) as myfile:
            lines = myfile.readlines()
    ...
    if event == "suggestions3":
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/suggestions_03.md"
        ) as myfile:
            lines = myfile.readlines()
    ...
    if event == "agreeing4":
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/agreeing_04.md"
        ) as myfile:
            lines = myfile.readlines()
    ...
    if event == "objecting5":
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/objecting_05.md"
        ) as myfile:
            lines = myfile.readlines()
    ...
    if event == "prioritizing6":
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/prioritizing_06.md"
        ) as myfile:
            lines = myfile.readlines()
    ...
    if event == "clarification7":
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/clarification_07.md"
        ) as myfile:
            lines = myfile.readlines()
    ...
    if event == "compromising8":
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/compromising_08.md"
        ) as myfile:
            lines = myfile.readlines()
    ...
    if event == "bargaining9":
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/bargaining_09.md"
        ) as myfile:
            lines = myfile.readlines()
    ...
    if event == "postponing10":
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/postponing_10.md"
        ) as myfile:
            lines = myfile.readlines()
    ...
    if event == "concluding11":
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/concluding_11.md"
        ) as myfile:
            lines = myfile.readlines()
    ...
    if event == "seal_the_deal12":
        with open(
            "/home/dgd/Desktop/python_storyboard_flashcards/negotiations_tab/seal_the_deal_12.md"
        ) as myfile:
            lines = myfile.readlines()
