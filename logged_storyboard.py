...
while True:
    ...
    if event == "generate_HTML":
        ...
        lines.append("<div> "+values["teacher_comments"] +" </div>" )        
        lines.append("<h3>vocabulary</h3>" )        
        lines.append("<table><tr><th>image: </th>     <th>challenge 1</th>      <th>challenge 2</th></tr>" )        
        for logline in values["vocabulary_log"].splitlines():
            lines.append("<tr>")
            for colnumber, cell in enumerate(logline.split("|")):
                if colnumber == 0:
                    lines.append("<td>" + cell+ "<br>" + "<img src='" + "/home/dgd/Desktop/python_storyboard_flashcards/random_images/" +cell+ ".png" + ">"     + "</td>")
                else:
    ...
    if "canvas" in event:
        ...
        p = Path(new)
        new = p.stem
        text += "\n" + new + " | " + values["bingo_text1"] + " | " + values["bingo_text2"]
